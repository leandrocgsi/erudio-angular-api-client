...
(function ($, undefined) {
    ...
    var KEY, AbstractSelect2, MultiSelect2;
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        prepareOpts: function (opts) {
            ...
            opts = $.extend({}, {
                ...
                formatNoMatches: function () { return "PESQUISANDO..."; },
...
//                "style": "width: " + this.getContainerWidth()
        ...
        clearSearch: function () {
            ...
            if (placeholder !== undefined
                ...
                //Quando o input não tem foco, o valor setado para o width é 100%
                this.search.val("").width(90+'%');
            }
        },
    ...
    $.fn.select2 = function () {
        ...
        this.each(function () {
            if (args.length === 0 || typeof(args[0]) === "object") {
                ...
                select2 = multiple ? new MultiSelect2() : MultiSelect2();
                select2.init(opts);
